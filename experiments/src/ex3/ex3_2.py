...
from crossvalidation import crossValidationLocationHour
from eval.rmse import rmseEval
from norm import NONORMALIZATION
from models.model_randomforest import trainRandomForest, applyRandomForest

outputFile = "/media/sf_lur/data_significance/result_hour_rfr.csv"
...
output.write("group,hour," + evalFunctionName + "\n")
...
#doEval(True, False, True, False, False, False, output)
