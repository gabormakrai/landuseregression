...
doGraph(overall1, "No2 hourly AE", "AE (ug/m3)", OUTPUT_DIRECTORY + "ae.png")
doGraph2(50, overall2, "No2 hourly error", "error (ug/m3)", OUTPUT_DIRECTORY + "e.png")
doGraph3(overall3, "No2 hourly ARE", "absolute relative error", OUTPUT_DIRECTORY + "rae.png")
doGraph4(overall4, "No2 hourly RE", "relative error", OUTPUT_DIRECTORY + "re.png")
