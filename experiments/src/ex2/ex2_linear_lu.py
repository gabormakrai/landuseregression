...
OUTPUT_DATA_FILE = "/experiments/ex2/ex2_linear_lu.csv"
...
onlyLUFeatures = ['lane_length', 'buildings_number', 'length', 'traffic_length_hgv', 'traffic_length_lgv', 'traffic_length_car', 'landuse_area']
 
output = open(OUTPUT_DATA_FILE, 'w')
output.write("location,observation,prediction\n")
 
for location in locations:
    trainX, testX, trainY, testY = splitDataForXValidation(location, "location", data, onlyLUFeatures, "target")
