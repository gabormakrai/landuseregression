...
INPUT_FILE = "/experiments/ex29/ex29_6_accuracy_output.csv"
OUTPUT_FILE = "/experiments/ex29/ex29_6_graph.png"
...
rmse_TW = [31.88 for i in range(0, len(steps))]
rmse_TWA = [34.73 for i in range(0, len(steps))]
...
l3, = ax1.plot(steps, rmses, 'r-', marker='o', linestyle='--')
...
ax2 = ax1.twinx()
s2 = steps
l4, = ax2.plot(steps, accuracies, 'y-', marker='o', linestyle='--')
