...
plt.text(1.15, -14.4, "$\mu$gm${}^{-3}$", fontsize=8)
plt.text(1.13, -17.3, "$\mu$gm${}^{-3}$", fontsize=8)
plt.text(2.15, -14.4, "$\mu$gm${}^{-3}$", fontsize=8)
plt.text(2.13, -17.3, "$\mu$gm${}^{-3}$", fontsize=8)
plt.text(3.15, -14.4, "$\mu$gm${}^{-3}$", fontsize=8)
plt.text(3.13, -17.3, "$\mu$gm${}^{-3}$", fontsize=8)
plt.text(4.15, -14.4, "$\mu$gm${}^{-3}$", fontsize=8)
plt.text(4.13, -17.3, "$\mu$gm${}^{-3}$", fontsize=8)
