...
OUTPUT_FILE = "/experiments/ex27/ex27_comb.txt"
...
for location in locations:
    ...
    for loc in location2s:
        ...
        trainX, testX, trainY, testY = splitDataForXValidationForCombination(loc, location, "location", data, all_features, "target")
    ...
    _, testX, _, testY = splitDataForXValidation(location, "location", data, all_features, "target")
