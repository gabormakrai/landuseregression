...
OUTPUT_FILE = "/experiments/ex27/ex27_comb_time.txt"
...
for location in locations:
    ...
    timesTW.append(time.time() - start_time)
    ...
    timesTWA.append(time.time() - start_time)
...
log("timesTW: " + str(timesTW))
log("sum(timesTW): " + str(sum(timesTW)))
log("timesTWA: " + str(timesTWA))
log("sum(timesTWA): " + str(sum(timesTWA)))
log("times: " + str(times))
